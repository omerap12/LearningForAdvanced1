...
#include "StudentAgeComparator.h"
#include "StudentAverageCompartor.h"
...
//    student->PrintStudent();
    ...
    StudentAgeComparator com1;
    sortStudents(s,com1,3);
    std::cout<<"After age: "<<std::endl;
    for (int i = 0; i<3; i++) {
        s[i] -> PrintStudent();
    }

    StudentAverageCompartor com2;
    sortStudents(s,com2,3);
    std::cout<<"After grades: "<<std::endl;
    for (int i = 0; i<3; i++) {
        s[i] -> PrintStudent();
    }
